...
document.addEventListener('DOMContentLoaded', () => {
    document.body.addEventListener('click', (event) => {
        ...
        if (whatsappButton) {
            ...
            const message = encodeURIComponent("Hola Carnes La Golosa, me gustaría solicitar una cotización e información sobre sus productos.");
            window.open(`https://wa.me/573237918080?text=${message}`, '_blank');
